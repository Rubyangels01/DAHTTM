...
<body>
	<header>
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				<div>
					<a class="navbar-brand" href="<c:url value = '/users/Main.htm' />">KITCHEN</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="menu">
					<ul class="navbar-nav mx-auto">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="<c:url value = '/users/Main.htm' />">Trang Chủ</a></li>
						...
						<li class="nav-item dropdown"><a
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item"
									href="<c:url value = '/users/Category.htm' />">Danh Mục Món
										Ăn</a></li>
								<li><a class="dropdown-item"
									href="<c:url value = '/users/Suggest.htm' />">Gợi Ý Hôm Nay</a></li>
								<li><a class="dropdown-item"
									href="<c:url value = '/users/Search_Food.htm' />">Tìm Kiếm
										Món Ăn</a></li>
								<li><a class="dropdown-item"
									href="<c:url value = '/users/Famous_List.htm' />">Món Ăn
										Phổ Biến</a></li>
								<li><a class="dropdown-item" href="#">Danh Sách Yêu
										Thích</a></li>
								<li><a class="dropdown-item"
									href="<c:url value = '/users/Create_Food.htm' />">Tạo Món
										Ăn</a></li>
							</ul></li>
					...
					<div>
						<button class="login-btn">
							<a aria-curent="location"
								href="<c:url value = '/users/Account.htm' />"><i
								class="fa-solid fa-user"></i> ${sessionScope.nameuser}</a>
						</button>
						...
						<div class="card-Name-meal">
							...
							<div>
								...
								<input class="Name-meal" type="text" name="tenmon"
									...
									placeholder="Mô tả món ăn" id="" required> <input
									class="py-5 px-5" type="text" id="fileInput"> 
								<p id="errorMessage"></p>
								<div class="px-5">
									<p>
